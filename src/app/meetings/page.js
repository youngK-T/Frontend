            ...
            <div className="flex items-center space-x-4 mb-4">
              <div className="flex-1 relative">
                <input
                  ...
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-300 focus:border-transparent text-gray-900 placeholder-gray-500"
                />
              ...
              <div className="relative min-w-[120px]" style={{zIndex: 1001}}>
                <select 
                  ...
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-300 text-gray-900 bg-white appearance-none pr-8 min-w-[120px]"
                  style={{
                    zIndex: 1002,
                    position: 'relative',
                    width: '120px'
